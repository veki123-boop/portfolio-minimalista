...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-between pt-20 md:pt-0 pb-20 relative overflow-hidden">
      {/* Tech Network Background Image - Right Side */}
      <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 w-1/2 h-full opacity-40 pointer-events-none">
        <img
          src="https://d2xsxph8kpxj0f.cloudfront.net/310519663441507986/KLXEcGa9PiyhytsRCs8ZDJ/hero-tech-network-63xrPcWaPvjfVui9z6g9Qu.webp"
          alt="Tech Network"
      ...
      <div className="hidden lg:block absolute inset-0 bg-gradient-to-r from-black via-transparent to-transparent pointer-events-none"></div>
    </section>
  );
}
